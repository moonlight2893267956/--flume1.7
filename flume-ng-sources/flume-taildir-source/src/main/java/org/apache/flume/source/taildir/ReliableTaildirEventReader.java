...
public class ReliableTaildirEventReader implements ReliableEventReader {
    ...
    private ReliableTaildirEventReader(Map<String, String> filePaths,
                                       ...
                                       boolean annotateFileName, String fileNameHeader, boolean openLevel) throws IOException {
        // Sanity checks
        ...
        for (Entry<String, String> e : filePaths.entrySet()) {
            taildirCache.add(new TaildirMatcher(e.getKey(), e.getValue(), cachePatternMatching, openLevel));
        }
    ...
    public static class Builder {
        ...
        public Builder openLevel(boolean openLevel) {
            this.openLevel = openLevel;
            return this;
        }
        ...
        public ReliableTaildirEventReader build() throws IOException {
            return new ReliableTaildirEventReader(filePaths, headerTable, positionFilePath, skipToEnd,
                    ...
                    annotateFileName, fileNameHeader, openLevel);
        }
    }
